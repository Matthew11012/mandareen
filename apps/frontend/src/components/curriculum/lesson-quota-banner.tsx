...
export interface LessonQuotaBannerProps
  extends React.HTMLAttributes<HTMLDivElement> {
  error: LessonQuotaError | null;
  generating: boolean;
...
export const LessonQuotaBanner = React.forwardRef<
  HTMLDivElement,
  LessonQuotaBannerProps
>(function LessonQuotaBannerInner(
  { error, generating, isQuotaExceeded, onRetry, onDismiss, ...rest },
  ref
) {
