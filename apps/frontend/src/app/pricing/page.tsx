...
const PLANS: PlanData[] = [
  {
    ...
    limits: [
      ...
      { resource: "convo_tts_seconds", label: "TTS minutes", value: "5" },
      {
    ...
    features: [
      ...
      "AI-guided lessons",
      "AI audio minutes (up to 5 per month)",
  ...
  },
  {
    ...
    features: [
      ...
      "AI audio minutes (up to 120 per month)",
  ...
  },
  {
    ...
    limits: [
      ...
      { resource: "convo_tts_seconds", label: "TTS minutes", value: "300" },
      {
        resource: "lesson_custom_generated",
        label: "Custom lessons",
        value: 200,
    ...
    features: [
      ...
      "Advanced conversation coach",
      "Unlimited AI lessons",
      "AI audio minutes (up to 300 per month)",
